...
def figure_7A_7B():
    ...
    fig_6A = [ [t[320:-135], max_sol[320:-135], 'navy',  '-', "PDE solution"],
               [t[320:-135], c[320:-135], 'purple',  '--', "DDE solution"] ]
    display_1d_multliple(fig_6A, xlab="t", ylab="Movement of the PDE and the DDE", title=None)
    
    # Figure 7B
    
    fig_6B = [ [t[320:-135], N_list[320:-135], 'navy',  '-', "$N_{pde}$"],
               [t[320:-135], N_dde_list[320:-135], 'purple',  '--', "$N_{dde}$"] ]
...
if __name__ == "__main__" :
    ...
    """ Total time to compute all the figures at once on a processor Intel Core i7-10510U CPU @ 1.80GHz 2.30 GHz and a 16,0 Go RAM: around 600 seconds """
    ...
    figure_7A_7B()           # Computation time: 60 seconds
